...
$sql="SELECT * from parande where id=$a  ";
   ...
   if(($row3[1]==$a  || $row3[3]==$a || $row3[5]==$a || $row3[7]==$a  || $row3[9]==$a ) && ($row3[2]==$reco  || $row3[4]==$reco || $row3[6]==$reco || $row3[8]==$reco  || $row3[10]==$reco))
{
  ...
  {
   $sql4="UPDATE recommend SET id1='$row3[3]' , reco1='$row3[4]' WHERE user_id=$b ";
   $sql5="UPDATE recommend SET id2='$row3[5]' , reco2='$row3[6]' WHERE user_id=$b ";
   $sql6="UPDATE recommend SET id3='$row3[7]' , reco3='$row3[8]' WHERE user_id=$b ";
   $sql7="UPDATE recommend SET id4='$row3[9]' , reco4='$row3[10]' WHERE user_id=$b ";
   $sql8="UPDATE recommend SET id5='$a' , reco5='$reco' WHERE user_id=$b ";
...
<script type="text/javascript">
   function cart(x,y)
   {
         ...
         xhttp.open("GET",'parande_cart.php?v='+x+"&sec="+y,true);
         xhttp.send();
