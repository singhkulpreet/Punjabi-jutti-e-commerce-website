...
<span id="fbLogout" onclick="fbLogout()"><a class="fb_button fb_button_medium" href="login222.php" ><span class="fb_button_text">Logout</span></a></span>
...
<?php
	...
	$redirect = 'http://localhost/juti_website/check/login222.php';
